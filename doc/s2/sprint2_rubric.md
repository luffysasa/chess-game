...
## Planning Meetings (sprintNbacklog.csv, sprintN.md) (max 3 marks)
  ...
  - Sprint Planning meeting (sprint2.md) (max 2 marks)
    ...
    Your Mark: 1 \
    Message: Not documented properly, capacity hours missing
  ...
  - Sprint N Backlog (sprintNBacklog.csv) (max 1 mark)
    ...
    Your Mark: 0.5 \
    Message: Sprint stories are not named properly
    
  Planning Meetings Total Mark: 1.5 / 3
...
## Featurework  (max 18 marks) 
  ...
  - Branch Naming (max 2 marks)
    ...
    Your Mark: 2
    Message: some branch names don't follow the requirements
...
DesignPattern Total Mark: 12 / 12
...
53.5 / 55 \
Message: Nicely done guys!!! good luck with your final exams :)
